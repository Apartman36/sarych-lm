...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SARYCH-LM v0.1 on synthetic sanity data.")
    parser.add_argument("--config", default="configs/v0_1_synthetic_sanity.yaml")
