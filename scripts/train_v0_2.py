...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SARYCH-LM v0.2 text pipeline smoke model.")
    parser.add_argument("--config", default="configs/v0_2_tinystories_smoke.yaml")
